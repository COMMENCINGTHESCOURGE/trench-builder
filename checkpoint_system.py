...
HUMAN_MOBILITY = {
    ...
    "checkpoints": [
        ...
        {"id": "H5", "name": "Bounce", "state": "Rhythmic knee oscillation",
         "muscles": ["quads","gastrocnemius","tibialis","glutes"],
         "energy": 65, "balance": "Dynamic vertical", "next": "H6",
         "flashcard": "Knees become springs. Glutes drive angles: hip-knee-ankle cascade. Foot angle, ham angle, hip angle oscillate. Arms counter-balance at opposite phase. Neck pivots to stabilize head. Each frame calculates joint angle increase/decrease across all 5 joints.",
         "angles": {
             "ankle": {"min": -15, "max": 25, "plane": "sagittal"},
             "knee": {"min": -30, "max": 5, "plane": "sagittal"},
             "hip": {"min": -20, "max": 15, "plane": "sagittal"},
             "shoulder": {"min": -12, "max": 12, "plane": "sagittal"},
             "neck": {"min": -3, "max": 3, "plane": "sagittal"}
         },
         "frame_calc": "angle(t) = min + (max-min) * (1+sin(t*freq+phase))/2. Phases: ankle 0, knee 15, hip 30, shoulder 180 (counter), neck 90 (stabilize)."},
        ...
        {"id": "H6", "name": "Walk", "state": "Reciprocal gait, alternating stance/swing",
         ...
         "flashcard": "Reciprocal gait cycle. 60% stance, 40% swing. Heel strike → mid-stance → toe-off. Arms counter-rotate for stability. Bounce taught the springs — walk releases them forward."},
